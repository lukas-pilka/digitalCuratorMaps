...
function Config() {
  this.data = {
    output_directory: 'output', // user specified out_dir or 'angels'
...
function Data() {
  this.atlasCount = null; // number of atlases provided in data angels
...
ConvexHullGrahamScan.prototype = {
  ...
  getHull: function () {
    ...
    // move first two points to angels array
